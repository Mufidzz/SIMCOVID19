...
CovidProvinsi covidProvinsiFromJson(String str) => CovidProvinsi.fromJson(json.decode(str));

String covidProvinsiToJson(CovidProvinsi data) => json.encode(data.toJson());
